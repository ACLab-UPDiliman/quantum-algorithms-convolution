...
def euclid_norm(cplex):
    # type: (complex) -> float
    """ returns the Euclidian norm of a complex number
    :param cplex: a complex number (a + bj)
    :type cplex: complex
    :return: the Euclidian norm of the input complex number
    :rtype: float
    """
    return sqrt(pow(cplex.real, 2) + pow(cplex.imag, 2))
